...
#define compassXMax 347.0f
#define compassXMin -512.0f
#define compassYMax 467.0f
#define compassYMin -281.0f
#define compassZMax 362.0f
#define compassZMin -343.0f
...
void loop(){
  ...
  if (millis() - printTimer > 50){
    ...
    Serial1.print(yaw);
    Serial1.print(",");
    Serial1.print(smoothAccX);
    Serial1.print(",");
    Serial1.print(smoothAccY);
    Serial1.print(",");
    Serial1.println(smoothAccZ);
  }
